...
namespace IoTHub.Foundation.Azure.Models.Templates
{
  ...
  public partial class IoTDevice : CustomItem
  {
    ...
    public static class FieldIds {
      ...
      public static readonly ID DeviceType = ID.Parse("{E30839DF-463E-490B-989E-51C86094360B}");
    ...
    /// <summary>Gets the "Device Type" field.</summary>
    public ReferenceField DeviceType 
    {
      get 
      {
        return this.InnerItem.Fields[FieldIds.DeviceType];
      }
    }
  ...
  /// <summary>Represents the "IoT Device Type" template.</summary>
  public partial class IoTDeviceType : CustomItem
  {
    public static readonly ID TemplateID = ID.Parse("{71D58260-B026-4EC8-B5D7-5221FDF008D2}");

    public IoTDeviceType(Item item) : base(item) {
    }
    ...
    public static IoTDeviceType Create(Item item) 
    {
      return new IoTDeviceType(item);
    }

    public static implicit operator Item (IoTDeviceType item)
    {
      if (item == null)
      {
        return null;
    ...
    public static explicit operator IoTDeviceType(Item item)
    {
      if (item == null)
      {
        return null;
